...
<body>
    <h1>Implementación de API´s de whatsapp, mediante burbujas fijas y flotantes</h1>
     ...
     <div class="callbutton">
        <div id="WAButton"></div>
        <div class="llamada">
           <a href="tel:<?php echo $telefono ?>" class="fas fa-phone-alt"></a> 
        </div>
    </div>
    ...
    <footer>
        ...
        <div class="burbujas">
            ...
            <a href="https://api.whatsapp.com/send/?phone=+52<?php echo $whats ?>&text=Hola+que+tal+necesito+ayuda&app_absent=0" target="_blank"><img class="burbuja-whatsapp" src="img/whatsapp.jpeg" alt=""></a>
           
            <!-- Utilizar para PC, laptop Web.whatsapp-->
            <a href="https://web.whatsapp.com/send?phone=+52<?php echo $whats ?>&text=¡Buen dia ...!" target="_blank"><img class="burbuja-whatsapp" src="img/whatsapp.jpeg" alt=""></a>
    ...
    <script>
        $(function() {
            $('#WAButton').floatingWhatsApp({
                phone: '52<?php echo $telefono ?>', //Número de telefono (Con prefijo 521 para México)
